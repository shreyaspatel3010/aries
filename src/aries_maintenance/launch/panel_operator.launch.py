...
Assumes MoveIt is up (aries_moveit) and the gripper camera is publishing; this
launch adds only the panel node, so it can be started and stopped against a live
sim without disturbing anything else.
"""
